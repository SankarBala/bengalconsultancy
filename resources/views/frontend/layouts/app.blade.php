                    ...
                    <div class="col-lg-3">
                        <div class="header-logo">
                            <a class="main-logo" href="{{ route('home') }}">
                                <img class="d-inline" src="{{ asset('frontend/assets/images/logo.png') }}" alt=""
                                    max-width="200px">
    ...
    <div class="footer-area">
        <div class="container">
            ...
            <div class="pt-15 text-white small">
                <b>Disclaimer:</b> Due to the frequent changes of information/ requirement/ document by the respective embassy, Bengal Consultancy does not provide any confirmation, guarantee or representation, express or implied that the information contained or referenced herein is completely accurate or final. Bengal Consultancy has no Liability for Incorrect Information/incomplete application of clients, no liability for Events Not in Our Control, no liability for wasted costs and expenses. Bengal Consultancy is not involved in the process of assessment of visa applications, or their grant or refusal, and shall not be liable or responsible for any delay by the respective Embassy in assessing, granting or refusing any visa application or for the grant or rejection of any visa application.
            </div>

            <div class="bd-top-footer pt-15 pb-15 small text-white text-center">
                &copy; Copyright {{date('Y')}} Bengal Consultancy.
            </div>
        </div>
    </div>
    <!--==================================================-->
